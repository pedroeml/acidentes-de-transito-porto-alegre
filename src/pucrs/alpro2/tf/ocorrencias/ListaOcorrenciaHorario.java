...
public class ListaOcorrenciaHorario extends ListaOcorrencia<OcorrenciaHorario> {
	
	public ListaOcorrenciaHorario() {
		super();
	}
	
	@Override
	public void add(OcorrenciaHorario o) {
		...
		if(super.getLista().isEmpty())
			...
			boolean done = false;
//			if(!done) {
				Iterator<OcorrenciaHorario> it = super.iterator();
				OcorrenciaHorario aux;
